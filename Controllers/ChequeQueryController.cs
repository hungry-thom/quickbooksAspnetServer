...
namespace api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class ChequeQueryController : ControllerBase
    {
        ...
        private readonly ILogger<ChequeQueryController> _logger;

        public ChequeQueryController(ILogger<ChequeQueryController> logger)
        {
            _logger = logger;
        }
